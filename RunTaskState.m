...
function RunTaskState( task_state_config, target, cori)
    ...
    target(RTMA.defines.MAX_CONTROL_DIMS+1:end) = [];
    ...
    % Send VR control configuration
    SendVRControlConfig( state_name, current_state_begin_time, task_state_config, target, cori);
